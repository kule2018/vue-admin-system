...
layui
  .define(["layer", "laytpl", "upload"], function(i) {
    var a = "3.7.1 Pro",
      e = layui.$,
      t = layui.layer,
      n = layui.laytpl,
    ...
    (c.prototype.config = function(i) {
      var a = [];
      if (
        (layui.each(Array(5), function(i) {
          a.push(
            layui.cache.dir + "css/modules/layim/skin/" + (i + 1) + ".jpg"
          );
        }),
        (i = i || {}),
        (i.skin = i.skin || []),
        ...
        (i.skin = a),
        (i = e.extend({ isfriend: !0, isgroup: !0, voice: "default.mp3" }, i)),
      ...
      (c.prototype.on = function(i, a) {
        return (
          "function" == typeof a && (r[i] ? r[i].push(a) : (r[i] = [a])), this
        );
      }),
        ...
        return (
          ...
          [
            ...
            '<li layim-event="chat" data-type="' +
              ...
              (i.index || "i") +
              ' }}" class="layim-' +
              ("history" === i.type ? "{{i}}" : i.type + "{{data.id}}") +
    ...
    var x,
            ...
            success: function(i, a) {
              (b = i),
                ...
                i.on("click", function() {
                  ...
                  delete i.close,
                    layui.data("layim", { key: j.mine.id, value: i });
                });
            }
          })
        );
      ...
      z = function(i) {
        ...
        if (a[0]) {
          ...
          return (
            "none" === w.css("display") && w.show(),
            k && t.close(k.attr("times")),
            1 !== s.find("li").length ||
              o[0] ||
              (d || w.css("width", 800),
              s.css({ height: w.height() }).show(),
              c.css("margin-left", "200px")),
            o[0] ||
              (s.append(n(v).render(l)), c.append(n(f).render(l)), I(i), E()),
            O(s.find(".layim-chatlist-" + i.type + i.id)),
            o[0] || P(),
            $(i),
            Q(),
        ...
        var u = (C = t.open({
          ...
          success: function(a) {
            (w = a),
              a.css({ "min-width": "500px", "min-height": "420px" }),
              I(i),
      ...
      I = function(i) {
        e(".layim-" + i.type + i.id).each(function() {
          e(this).hasClass("layim-list-gray") &&
            layui.layim.setFriendStatus(i.id, "offline");
        });
      },
      E = function() {
            ...
            success: function(a, l) {
              i || (k = a),
                ...
                a.find(".layui-layer-content span").on("click", function() {
                  t.close(l),
                    i
                      ? layui.each(j.chat, function(i, a) {
                          z(a);
                        })
                      : w.show(),
                    i && ((j.chat = []), Z());
        ...
        return (
          ...
          (M.index = t.open({
            ...
            yes: function(e, t) {
              ...
              a
                ? i.submit && i.submit(n.val(), e)
                : i.submit && i.submit(n.val(), l.val(), e);
            }
          }))
        );
      },
      ...
      $ = function(i) {
        ...
        if (x) {
          ...
          if (
            ...
            e[i.type + i.id] = i;
            var o = n(u({ type: "history", item: "d.data" })).render({
              data: e
            });
        ...
        if (((i = i || {}), window.Notification))
          if ("granted" === Notification.permission) {
            new Notification(i.title || "", {
              body: i.content || "",
              icon:
                i.avatar || "http://tp2.sinaimg.cn/5488749285/50/5719808192/1"
            });
      ...
      K = function(i) {
        ...
        if (
          ...
          if (j.message[i.type + i.id]) j.message[i.type + i.id].push(i);
            ...
            layui.each(j.friend, function(a, e) {
              if (
                (layui.each(e.list, function(a, e) {
                  if (e.id == i.id)
                    return (
                      (e.type = "friend"),
                      (e.name = e.username),
        ...
        if (w) {
          var d = _();
          d.data.type + d.data.id !== i.type + i.id &&
            (a.addClass("layui-anim layer-anim-06"),
            setTimeout(function() {
          ...
          i.system
            ...
            : "" !== i.content.replace(/\s/g, "") && c.append(n(h).render(i)),
            Z();
        }
      },
        ...
        if (j[i.type])
          if ("friend" === i.type)
            layui.each(j.friend, function(n, l) {
              if (i.groupid == l.id)
                return (
                  layui.each(j.friend[n].list, function(e, t) {
            ...
            if (
              (layui.each(j.group, function(e, t) {
                if (t.id == i.id) return (a = !0);
              }),
              a)
            )
      ...
      W = function(i) {
        ...
        j[i.type] &&
          ("friend" === i.type
            ? layui.each(j.friend, function(e, t) {
              ...
              layui.each(j.group, function(e, t) {
                if (i.id == t.id)
                  return (
                    ...
                    j.group.splice(e, 1),
                    0 === j.group.length &&
                      a.html('<li class="layim-null">暂无群组</li>'),
                    !0
                  );
              }));
      },
      ...
      ti = {
        status: function(i, a) {
          ...
          if ("show" === n)
            ...
            i
              ...
              l
                .removeClass(
                  "layim-status-" + ("online" === n ? "hide" : "online")
                )
                .addClass("layim-status-" + n),
        ...
        spread: function(i) {
          ...
          i.next()["true" === a ? "removeClass" : "addClass"](s),
            ...
            layui.data("layim", { key: j.mine.id, value: t }),
            i.attr("lay-type", e),
        ...
        search: function(i) {
              ...
              if ("" === a) ti.tab(0 | ti.tab.index);
                ...
                for (
                  ...
                  for (var r = 0; r < (l[d].list || []).length; r++)
                    l[d].list[r].username.indexOf(a) !== -1 &&
                      ((l[d].list[r].type = "friend"),
                      (l[d].list[r].index = d),
                      (l[d].list[r].list = r),
                      n.push(l[d].list[r]));
                for (var c = 0; c < s.length; c++)
                  s[c].groupname.indexOf(a) !== -1 &&
                    ((s[c].type = "group"),
                    (s[c].index = c),
                    (s[c].list = c),
                    n.push(s[c]));
          ...
          !j.base.isfriend && j.base.isgroup
            ? (ti.tab.index = 1)
            : j.base.isfriend || j.base.isgroup || (ti.tab.index = 2),
            a.show(),
            t.focus(),
        ...
        setSkin: function(i) {
          ...
          (e.skin = a),
            a || delete e.skin,
            layui.data("layim", { key: j.mine.id, value: e });
          try {
            x.css({ "background-image": a ? "url(" + a + ")" : "none" }),
              w.css({ "background-image": a ? "url(" + a + ")" : "none" });
          } catch (t) {}
          layui.each(r.setSkin, function(i, e) {
            var t = (a || "").replace(
              layui.cache.dir + "css/modules/layim/skin/",
              ""
            );
            e && e(t, a);
          });
                ...
                i,
                {
                  ...
                  success: function(a) {
                    var t = j.base.members || {},
                      ...
                      d = {},
                      c = w
                        .find(".layui-layer-max")
                        .hasClass("layui-layer-maxmin"),
                      u = "none" === w.find(".layim-chat-list").css("display");
                    c && s.css({ width: e(window).width() - 22 - (u || 200) }),
                      (t.data = e.extend(t.data, { id: n.data.id })),
                      S(t, function(a) {
                        layui.each(a.list, function(i, a) {
                          ...
                          i
                            ...
                            .html(a.members || (a.list || []).length + "人"),
        ...
        setSend: function(i, a) {
          ...
          if ("show" === n)
            ii(a),
              t.show().addClass(ei),
              e(document)
                .off("click", ti.setSendHide)
                .on("click", ti.setSendHide);
          else {
            i.addClass(o)
              .siblings()
              .removeClass(o);
            ...
            (l.sendHotKey = n),
              layui.data("layim", { key: j.mine.id, value: l }),
        ...
        face: function(i, a) {
          ...
          (n = '<ul class="layui-clear layim-face-list">' + n + "</ul>"),
            ...
            e(document)
              .off("mousedown", ti.faceHide)
              .on("mousedown", ti.faceHide),
            e(window)
              .off("resize", ti.faceHide)
              .on("resize", ti.faceHide),
            ii(a);
        },
        faceHide: function() {
          t.close(ti.face.index);
        ...
        image: function(i) {
          var a = i.data("type") || "images",
            e = { images: "uploadImage", file: "uploadFile" },
            n = _(),
            l = j.base[e[a]] || {};
          layui.upload.render({
            url: l.url || "",
            ...
            accept: a,
              ...
              0 == i.code
                ? ((i.data = i.data || {}),
                  "images" === a
                    ? ai(n.textarea[0], "img[" + (i.data.src || "") + "]")
                    : "file" === a &&
                      ai(
                        n.textarea[0],
                        "file(" +
        ...
        chatLog: function(i) {
          var a = _();
          return j.base.chatLog
            ? (t.close(ti.chatLog.index),
        ...
        menuHistory: function(i, a) {
          ...
          if ("one" === s) {
            ...
            delete r[l.data("index")],
              (n.history = r),
              layui.data("layim", { key: j.mine.id, value: n }),
              e("#" + l.data("id")).remove(),
