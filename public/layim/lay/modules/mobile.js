...
layui
  .define(["laytpl", "upload-mobile", "layer-mobile", "zepto"], function(i) {
    var e = "2.1.0",
      a = layui.zepto,
      t = layui.laytpl,
      ...
      u = function() {
        (this.v = e),
          m(a("body"), "*[layim-event]", function(i) {
            var e = a(this),
          ...
          y
            ? void (l
                ? i
                    ...
                    .on("touchend", s)
                : i
                    .on("touchmove", e, function() {
                      n = !0;
                    })
                    .on("touchend", e, s))
            : void (l ? i.on("click", s) : i.on("click", e, s))
        );
      },
      y = /Android|iPhone|SymbianOS|Windows Phone|iPad|iPod/.test(
        navigator.userAgent
      );
    (n.popBottom = function(i) {
      ...
      (u.prototype.on = function(i, e) {
        return (
          "function" == typeof e && (r[i] ? r[i].push(e) : (r[i] = [e])), this
        );
      }),
      (u.prototype.chat = function(i) {
        if (window.JSON && window.JSON.parse) return L(i, -1), this;
      }),
    ...
    var p = function(i) {
        ...
        return (
          ...
          [
            ...
            '<li layim-event="chat" data-type="' +
              ...
              (i.index
                ? "{{" + i.index + "}}"
                : ("history" === i.type ? "{{data.type}}" : i.type) +
                  "{{data.id}}") +
              '" class="layim-' +
              ("history" === i.type ? "{{data.type}}" : i.type) +
              '{{data.id}} {{ data.status === "offline" ? "layim-list-gray" : "" }}"><div><img src="{{data.avatar}}"></div><span>{{ data.username||data.groupname||data.name||"佚名" }}</span><p>{{ data.remark||data.sign||"" }}</p><span class="layim-msg-status">new</span></li>',
            "{{# }); if(length === 0){ }}",
            '<li class="layim-null">' + (e[i.type] || "暂无数据") + "</li>",
            "{{# } }}"
          ].join("")
        );
      },
      f = function(i, e, a) {
        return [
          '<div class="layim-panel' + (e ? " layui-m-anim-left" : "") + '">',
    ...
    var b,
        ...
        return (
          ...
          (create = function(e) {
            ...
            (s.sortHistory = j(s.history, "historyTime")),
              (C = a.extend(C, s)),
              S(t(f(h)).render(s)),
              layui.each(r.ready, function(i, e) {
                e && e(s);
              });
          }),
          (C = a.extend(C, obj)),
        ...
        return n.open({
          ...
          success: function(i) {
            (b = a(i)),
              ...
              C.base.tabIndex &&
                U.tab(a(".layui-layim-tab>li").eq(C.base.tabIndex));
          }
        });
      },
      N = function(i, e) {
        i = i || {};
        var l = a.extend({}, C, { title: i.title || "", data: i.data });
        return n.open({
          type: 1,
          shade: !1,
          shadeClose: !1,
              ...
              (L.index = N(
                {
                  ...
                  success: function(e) {
                    ...
                    layui.each(r.chatChange, function(i, e) {
                      e && e(t);
                    }),
                      T(n),
        ...
        s.ios &&
          i.on("touchmove", function(e) {
            ...
            a <= 0 && (i.scrollTop(1), e.preventDefault(e)),
              this.scrollHeight - a - i.height() <= 0 &&
                (i.scrollTop(i.scrollTop() - 1), e.preventDefault(e));
          });
      },
      A = function() {
        if (!x) return {};
        var i = x.find(".layim-chat"),
          e = JSON.parse(
            decodeURIComponent(i.find(".layim-chat-tool").data("json"))
          );
        return { elem: i, data: e, textarea: i.find("input") };
      },
      j = function(i, e, a) {
        var t = [],
          n = function(i, a) {
      ...
      H = function(i) {
        ...
        if (b) {
          ...
          (i.historyTime = new Date().getTime()),
            ...
            (n[i.type + i.id] = i),
            (e.history = n),
            layui.data("layim-mobile", { key: C.mine.id, value: e });
          ...
          if (s.length > 0) d(), l.prepend(s.clone()), s.remove();
            ...
            a[i.type + i.id] = i;
            var r = t(p({ type: "history", item: "d.data" })).render({
              data: a
            });
      ...
      q = function() {
        ...
        if (((i.content = c.val()), "" !== i.content)) {
          ...
          F(u),
            layui.each(r.sendMessage, function(i, e) {
              e && e(d);
            }),
            (l.content = i.content),
            H(l),
      ...
      M = function(i) {
        ...
        (i.timestamp = i.timestamp || new Date().getTime()),
          ...
          C.base.voice && _(),
          ((!x && i.content) || !s) &&
            (C.message[i.type + i.id]
              ? C.message[i.type + i.id].push(i)
              : (C.message[i.type + i.id] = [i]));
        var e = {};
        if ("friend" === i.type) {
          var o;
          layui.each(C.friend, function(e, a) {
            if (
              (layui.each(a.list, function(e, a) {
                if (a.id == i.id)
                  return (i.type = "friend"), (i.name = a.username), (o = !0);
              }),
              o)
            )
              return !0;
          ...
          "group" === i.type
            ? layui.each(C.group, function(a, t) {
                if (t.id == i.id)
                  return (
                    (i.type = "group"),
      ...
      F = function(i) {
        var e = layui.data("layim-mobile")[C.mine.id] || {},
          a = e.chatlog || {};
        a[i.type + i.id]
          ? (a[i.type + i.id].push(i),
            a[i.type + i.id].length > d && a[i.type + i.id].shift())
          : (a[i.type + i.id] = [i]),
          (e.chatlog = a),
          layui.data("layim-mobile", { key: C.mine.id, value: e });
      },
      ...
      O = function(i) {
        ...
        if (C[i.type])
          if ("friend" === i.type)
            layui.each(C.friend, function(t, l) {
              if (i.groupid == l.id)
                return (
                  layui.each(C.friend[t].list, function(a, t) {
                    if (t.id == i.id) return (e = !0);
                  }),
                  e
                    ? n.msg(
                        "好友 [" + (i.username || "") + "] 已经存在列表中",
                        { anim: 6 }
                      )
                    : ((C.friend[t].list = C.friend[t].list || []),
                      (a[C.friend[t].list.length] = i),
                      (i.groupIndex = t),
                      C.friend[t].list.push(i),
                      !0)
                );
            });
            ...
            (a[C.group.length] = i), C.group.push(i);
          }
        if (!e) {
          var s = t(
            p({
      ...
      Y = function(i) {
        ...
        C[i.type] &&
          ("friend" === i.type
            ? layui.each(C.friend, function(a, t) {
              ...
              layui.each(C.group, function(a, t) {
                if (i.id == t.id)
                  return (
                    ...
                    C.group.splice(a, 1),
                    0 === C.group.length &&
                      e.html('<li class="layim-null">暂无群组</li>'),
                    !0
                  );
              }));
      },
      J = function() {
        ...
        if (t.length >= d) {
          var n = t.eq(0);
          n.prev().remove(),
            a.prev().hasClass("layim-chat-system") ||
              a.before(
        ...
        a || i.focus(),
          document.selection
            ? ((t = document.selection.createRange()),
              ...
              (t.text = e))
            : ((t = [
                n.substring(0, i.selectionStart),
                e,
                n.substr(i.selectionEnd)
              ]),
              a || i.focus(),
              (i.value = t.join("")));
      },
      U = {
        ...
        spread: function(i) {
          ...
          i.next()["true" === e ? "removeClass" : "addClass"](o),
            ...
            layui.data("layim-mobile", { key: C.mine.id, value: t }),
            i.attr("lay-type", a),
        ...
        back: function(i) {
          ...
          setTimeout(function() {
            ...
            layui.each(r.back, function(i, e) {
              setTimeout(function() {
                e && e();
              }, 200);
            });
        ...
        face: function(i, e) {
          ...
          layui.each(E, function(i, e) {
            ...
            n.popBottom({
              ...
              success: function(i) {
                var e = a(i)
                  .find(".layui-layim-face")
                  .children("li");
                m(e, function() {
                  return (
                    R(s[0], "face" + this.title + " ", !0),
                    s
                      .next()
          ...
          var o = a(document);
          y
            ? o.off("touchend", U.faceHide).on("touchend", U.faceHide)
            : o.off("click", U.faceHide).on("click", U.faceHide),
            P(e);
        },
        faceHide: function() {
          n.close(n.popBottom.index),
            a(document)
              .off("touchend", U.faceHide)
              .off("click", U.faceHide);
        },
        image: function(i) {
          var e = i.data("type") || "images",
            a = { images: "uploadImage", file: "uploadFile" },
            t = A(),
            s = C.base[a[e]] || {};
          l({
            url: s.url || "",
        ...
        extend: function(i) {
          var e = i.attr("lay-filter"),
            a = A();
          layui.each(r["tool(" + e + ")"], function(e, t) {
            t &&
              t.call(
                i,
                function(i) {
        ...
        newFriend: function() {
          layui.each(r.newFriend, function(i, e) {
            e && e();
          });
        },
        group: function() {
          N({
            title: "群聊",
            tpl: [
              '<div class="layui-layim-list layim-list-group">',
        ...
        detail: function() {
          var i = A();
          layui.each(r.detail, function(e, a) {
            a && a(i.data);
          });
        },
        ...
        playVideo: function(i) {
          ...
          return a.play
            ? (n.close(U.playVideo.index),
              void (U.playVideo.index = n.open({
                type: 1,
                anim: !1,
        ...
        chatLog: function(i) {
          var e = A();
          layui.each(r.chatlog, function(i, a) {
            a && a(e.data, e.elem.find(".layim-chat-main>ul"));
          });
        },
        moreList: function(i) {
          var e = i.attr("lay-filter");
          layui.each(r.moreList, function(i, a) {
            a && a({ alias: e });
          });
        },
        about: function() {
          n.open({
            content:
              '<p style="padding-bottom: 5px;">LayIM属于付费产品，欢迎通过官网获得授权，促进良性发展！</p><p>当前版本：layim mobile v' +
              e +
              '</p><p>版权所有：<a href="http://layim.layui.com" target="_blank">layim.layui.com</a></p>',
...
layui["layui.mobile"] ||
  layui.config({ base: layui.cache.dir + "lay/modules/mobile/" }).extend({
