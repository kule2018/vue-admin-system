            ...
            "function" == typeof a &&
              !(function c() {
                return ++d > 80
                  ...
                  : void (1989 ===
                    parseInt(t.getStyle(document.getElementById(l), "width"))
                      ? a()
                      : setTimeout(c, 100));
              })();
        }
    ...
    n = {
      ...
      ready: function(a) {
        ...
        return "function" == typeof define && define.amd
          ? a()
          : (e ? layui.addcss(o, a, i) : t.link(o, a, i), this);
      }
    },
    a = function() {
      var e = this;
      ...
      for (
        var t = 0,
          n =
            "object" == typeof e
              ? [e]
              : ((this.selector = e), document.querySelectorAll(e || null));
        t < n.length;
        t++
      )
        this.push(n[t]);
  ...
  (w.prototype = []),
    ...
    (D.prototype.render = function() {
      ...
      if (
        ...
        T.each(new Array(2), function(e) {
          ...
          var a = T.elem("div", { class: "layui-laydate-header" }),
            i = [
              (function() {
                var e = T.elem("i", {
              ...
              (function() {
                var e = T.elem("div", { class: "laydate-set-ym" }),
                  t = T.elem("span"),
                  n = T.elem("span");
            ...
            d = T.elem("div", { class: "layui-laydate-content" }),
            c = T.elem("table"),
            m = T.elem("thead"),
            u = T.elem("tr");
        ...
        "styleSheet" in c
          ? (c.setAttribute("type", "text/css"), (c.styleSheet.cssText = m))
          : (c.innerHTML = m),
      ...
      e.remove(),
        ...
        "function" == typeof t.ready &&
          t.ready(T.extend({}, t.dateTime, { month: t.dateTime.month + 1 }));
    }),
    ...
    (D.prototype.checkDate = function(e) {
      var t,
        ...
        l =
          ...
          i.isInput(s) ? s.value : "static" === r.position ? "" : s.innerHTML),
        c = function(e) {
      ...
      return "limit" === e
        ...
        : ((l = l || r.value),
          ...
          a &&
            l &&
            i.setValue(r.range ? (i.endDate ? i.parse() : "") : i.parse()),
          e && e(),
          i);
    }),
    ...
    (D.prototype.limit = function(e, t, n, a) {
      var i,
        ...
        c = T.extend({}, d, t || {});
      return (
        T.each({ now: c, min: o.min, max: o.max }, function(e, t) {
          l[e] = r
            .newDate(
              T.extend(
    ...
    (D.prototype.calendar = function(e) {
      ...
      if (
        (l.year < d[0] &&
          ((l.year = d[0]), r.hint("最低只能支持到公元" + d[0] + "年")),
        l.year > d[1] &&
          ((l.year = d[1]), r.hint("最高只能支持到公元" + d[1] + "年")),
        ...
        T.each(y, function(e, n) {
          ...
          (n = T(n)),
            ...
            r
              .mark(n, d)
              .limit(n, { year: d[0], month: d[1] - 1, date: d[2] }, e);
        }),
          ...
          (s.range &&
            ...
            e &&
              ...
              "time" === s.type
                ? r.setBtnStatus(
                    "时间",
                    T.extend({}, r.systemDate(), r.startTime),
                    T.extend({}, r.systemDate(), r.endTime)
                  )
                : r.setBtnStatus(!0))),
      ...
      return (
        s.range ||
          r.limit(T(r.footer).find(p), null, 0, [
            "hours",
            "minutes",
            "seconds"
          ]),
    ...
    (D.prototype.list = function(e, t) {
      ...
      if ((w[0] < 1 && (w[0] = 1), "year" === e)) {
          ...
          T.each(new Array(15), function(e) {
            ...
            M == w[0] && T(i).addClass(o),
              ...
              M < n.firstDate.year
                ...
                : M >= n.firstDate.year &&
                  ((r.month = a.max.month), (r.date = a.max.date)),
              n.limit(T(i), r, t),
              M++;
          }),
          T(u[f ? 0 : 1])
        ...
        T.each(new Array(12), function(e) {
          ...
          e + 1 == w[1] && T(i).addClass(o),
            ...
            w[0] < n.firstDate.year
              ? (s.date = a.min.date)
              : w[0] >= n.firstDate.year && (s.date = a.max.date),
            n.limit(T(i), s, t);
        }),
          T(u[f ? 0 : 1])
            .attr("lay-ym", w[0] + "-" + w[1])
        ...
        var E = function() {
          T(d)
              ...
              T(a)
                ...
                .each(function(a, i) {
                  n.limit(
                    ...
                    [
                      { hours: a },
                      { hours: n[C].hours, minutes: a },
                      { hours: n[C].hours, minutes: n[C].minutes, seconds: a }
                    ][e],
                    t,
                    [
                      ["hours"],
            ...
            a.range ||
              n.limit(T(n.footer).find(p), n[C], 0, [
                "hours",
                "minutes",
                "seconds"
              ]);
        ...
        a.range
          ? n[C] || (n[C] = { hours: 0, minutes: 0, seconds: 0 })
          : (n[C] = i),
      ...
      if (
        (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e)
      )
            ...
            .on("click", function() {
              ...
              if (!T(this).hasClass(s)) {
                if (0 === t)
                  (i[e] = r),
                    l && (n.startDate[e] = r),
                    n.limit(T(n.footer).find(p), null, 0);
                else if (l) n.endDate[e] = r;
                else {
                  var c =
                    "year" === e
                      ? n.getAsYM(r, w[1] - 1, "sub")
                      : n.getAsYM(w[0], r, "sub");
              ...
              T(t)
                ...
                .on("click", function() {
                  ...
                  T(this).hasClass(s) ||
                    ...
                    n.setBtnStatus(
                      null,
                      T.extend({}, n.systemDate(), n.startTime),
                      T.extend({}, n.systemDate(), n.endTime)
                    ),
                    E(),
                    k(),
      ...
      var n = this,
        ...
        i =
          ...
          (e
            ...
            : a.range
            ? T.extend({}, n.startDate, n.startTime)
            : a.dateTime),
        r = n.format.concat();
      return (
        T.each(r, function(e, t) {
          /yyyy|y/.test(t)
            ? (r[e] = T.digit(i.year, t.length))
            : /MM|M/.test(t)
            ? (r[e] = T.digit(i.month + 1, t.length))
            : /dd|d/.test(t)
            ? (r[e] = T.digit(i.date, t.length))
            : /HH|H/.test(t)
            ? (r[e] = T.digit(i.hours, t.length))
            : /mm|m/.test(t)
            ? (r[e] = T.digit(i.minutes, t.length))
            : /ss|s/.test(t) && (r[e] = T.digit(i.seconds, t.length));
        }),
        a.range && !e
    ...
    (D.prototype.stampRange = function() {
      ...
      if (
        ...
        return (
          ...
          e > t
            ? n.hint(l)
            : void T.each(i, function(a, i) {
                var r = T(i)
                    .attr("lay-ymd")
                    .split("-"),
                  s = n
                    .newDate({ year: r[0], month: r[1] - 1, date: r[2] })
                    .getTime();
                T(i).removeClass(m + " " + o),
                  (s !== e && s !== t) ||
                    T(i).addClass(T(i).hasClass(h) || T(i).hasClass(y) ? m : o),
      ...
      var t = this,
        ...
        l = function(e) {
          ...
          e && T.extend(a, r),
            n.range &&
              (t.startDate
                ? T.extend(t.startDate, r)
                : (t.startDate = T.extend({}, r, t.startTime)),
              (t.startYMD = r));
        };
      if (
        ...
        if (n.range) {
          if (
            (T.each(["startTime", "endTime"], function(e, n) {
            ...
            if (
              (e.addClass(o),
              t.endDate
                ? T.extend(t.endDate, r)
                : (t.endDate = T.extend({}, r, t.endTime)),
        ...
        o = {
          ...
          confirm: function() {
            if (a.range) {
              ...
              if (T(e).hasClass(s))
                return n.hint(
                  "time" === a.type ? l.replace(/日期/g, "时间") : l
                );
        ...
        s = function(s) {
          ...
          return (
            ...
            (d || c) &&
              ...
              t.setBtnStatus(),
              n.range || t.limit(T(t.footer).find(p), { year: o[0] })),
            d || c
          );
        };
      return {
      ...
      (S = t.select = function(e, t, n, r) {
        ...
        if (((n = n || []), 1 === f.length)) {
          if (
            ...
            if (
              ((t = (T.find.ID(a.matches[0].replace(be, we), t) || [])[0]), !t)
            )
              return n;
    ...
    y = {
      tabClick: function(i, t, s) {
        var o = s || a(this),
          ...
          u = o.find("a"),
          d = c.attr("lay-filter");
        ("javascript:;" !== u.attr("href") && "_blank" === u.attr("target")) ||
          (o
            .addClass(e)
            .siblings()
            .removeClass(e),
          r
            ...
            .siblings()
            .removeClass(n)),
          layui.event.call(this, l, "tab(" + d + ")", { elem: c, index: t });
      },
      tabDelete: function(i, t) {
        ...
        l.hasClass(e) &&
          (l.next()[0]
            ? y.tabClick.call(l.next()[0], null, n + 1)
            : l.prev()[0] && y.tabClick.call(l.prev()[0], null, n - 1)),
          l.remove(),
          o.eq(n).remove(),
          setTimeout(function() {
            y.tabAuto();
      ...
      tabAuto: function() {
        ...
        a(".layui-tab").each(function() {
          ...
          if (
            (n === window && 8 != t.ie && y.hideTabMore(!0),
      ...
      hideTabMore: function(i) {
        ...
        (i !== !0 && "tabmore" === a(i.target).attr("lay-stope")) ||
      ...
      clickThis: function() {
        ...
        i.find("." + d)[0] ||
          (("javascript:;" !== s.attr("href") &&
            ...
            (t.find("." + e).removeClass(e), i.addClass(e)),
      ...
      showChild: function() {
        ...
        t.hasClass(u) &&
          (e.removeClass(f),
          l["none" === e.css("display") ? "addClass" : "removeClass"](
            c + "ed"
          ));
      },
      collapse: function() {
          ...
          p = function(o, c, r) {
            ...
            c.hasClass(u)
              ...
              : (p.addClass(f),
                ...
                clearTimeout(s[r]),
                "block" === p.css("display") && clearTimeout(e[r]),
  ...
  (p.prototype.config = {
    ...
    (p.prototype.file = function() {
      var e = this,
        ...
        n = (e.elemFile = i(
          [
            '<input class="' + u + '" type="file" name="' + t.field + '"',
            t.multiple ? " multiple" : "",
            ">"
          ].join("")
        )),
    ...
    (p.prototype.initIE = function() {
      var e = this,
        ...
        a = i(
          [
            '<form target="' + s + '" class="' + c + '" method="' + t.method,
      ...
      i("#" + s)[0] || i("body").append(n),
        t.elem.next().hasClass(s) ||
          (e.elemFile.wrap(a),
          t.elem.next("." + s).append(
            (function() {
              var e = [];
              return (
                layui.each(t.data, function(i, t) {
                  e.push(
    ...
    (p.prototype.preview = function(e) {
      var i = this;
      window.FileReader &&
        layui.each(i.chooseFiles, function(i, t) {
    ...
    (p.prototype.upload = function(e, t) {
      var n,
        ...
        h = (function() {
          var i = [];
          return (
            layui.each(e || o.chooseFiles, function(e, t) {
              i.push(t.name);
            }),
            i
          );
      ...
      switch (
        ((h = 0 === h.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : h),
        l.accept)
      ) {
        case "file":
        ...
        case "video":
          if (
            !RegExp(
              "\\w\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$",
              "i"
            ).test(escape(h))
          )
        ...
        if (
          (layui.each(o.chooseFiles, function(e, i) {
            if (i.size > 1024 * l.size) {
              ...
              (t =
                t >= 1
                  ? Math.floor(t) + (t % 1 > 0 ? t.toFixed(1) : 0) + "MB"
                  : l.size + "KB"),
                (r.value = ""),
                (F = t);
            }
      ...
      var e = this,
        ...
        l = function(i, n) {
          ...
          a.next().hasClass(f) && a.next().remove(),
            ...
            e.isFile() ||
              t.choose ||
              a.after('<span class="layui-inline ' + f + '">' + o + "</span>");
        };
            ...
            var e,
              ...
              h = function(t, o, f) {
                ...
                if (!o) {
                  var b = function() {
                      var e =
                          t.offset().top + t.outerHeight() + 5 - v.scrollTop(),
                        i = k.outerHeight();
                      t.addClass(a + "ed"),
                        g.removeClass(u),
                ...
                a.on("click", function() {
                  ...
                  n[0].disabled ||
                    ...
                    a
                      ...
                      .addClass(r)
                      .html(t[0]),
                    layui.event.call(n[0], l, "radio(" + o + ")", {
                      elem: n[0],
                      value: n[0].value,
                      othis: a
                    }));
...
layui.define("jquery", function(e) {
  ...
  (r.prototype.init = function(e) {
    ...
    e("tree", function(e) {
      ...
      return t[0]
        ? void i.init(t)
        : a.error("layui.tree 没有找到" + e.elem + "元素");
    });
});
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
  ...
  (A.prototype.config = { limit: 30, loading: !0 }),
    (A.prototype.render = function(e) {
      ...
      a.height &&
        ...
        ((l.fullHeightGap = a.height.split("-")[1]),
        (a.height = T.height() - l.fullHeightGap));
      var r = (l.elem = t(
        i(N).render({ VIEW_CLASS: h, data: a, index: l.index })
      ));
      if (
        ((a.index = l.index),
        o[0] && o.remove(),
        n.after(r),
        (l.layHeader = r.find(y)),
        (l.layMain = r.find(m)),
        (l.layBody = r.find(p)),
        (l.layFixed = r.find(v)),
        (l.layFixLeft = r.find(g)),
        (l.layFixRight = r.find(x)),
        (l.layTool = r.find(b)),
        a.height && l.fullSize(),
        a.cols.length > 1)
      ) {
        ...
        d.height(
          l.layHeader.height() -
            1 -
            parseFloat(d.css("padding-top")) -
            parseFloat(d.css("padding-bottom"))
        );
      }
      ...
      var a = this,
        ...
        d = function() {
          "object" == typeof n.initSort &&
            a.sort(n.initSort.field, n.initSort.type);
        };
      if (n.url) {
        var c = {};
        (c[o.pageName] = e),
    ...
    (A.prototype.renderData = function(e, n, o, r) {
                  ...
                  c.eachCols(function(e, r) {
                    ...
                    if (
                      ...
                      l.push(u),
                        ...
                        "right" === r.fixed && o.push(u);
                    }
                  }),
                  f.push('<tr data-index="' + e + '">' + l.join("") + "</tr>"),
                  h.push('<tr data-index="' + e + '">' + n.join("") + "</tr>"),
                  y.push('<tr data-index="' + e + '">' + o.join("") + "</tr>"));
              }),
              c.layBody.scrollTop(0),
              c.layMain.find("tbody").html(f.join("")),
              c.layFixLeft.find("tbody").html(h.join("")),
              c.layFixRight.find("tbody").html(y.join("")),
              c.renderForm(),
              c.syncCheckAll(),
              c.haveInit
                ? c.scrollPatch()
      ...
      return (
        ...
        r
          ...
          ? (c.renderForm(),
            c.layFixed.remove(),
            c.layMain.html('<div class="layui-none">无数据</div>'))
          : (p(),
            void (
              s.page &&
              ((c.page = n),
    ...
    (A.prototype.sort = function(e, i, a, n) {
      ...
      try {
        ...
        if (u.sortKey && !a && r === u.sortKey.field && i === u.sortKey.sort)
          return;
        var p = u.layHeader
          .find("th .laytable-cell-" + f.index + "-" + r)
          .find(k);
        u.layHeader
          .find("th")
          .find(k)
      ...
      (u.sortKey = { field: r, sort: i }),
        "asc" === i
          ...
          : "desc" === i
          ? (c = layui.sort(y, r, !0))
          : ((c = layui.sort(y, d.config.indexName)), delete u.sortKey),
        u.renderData({ data: c }, u.page, u.count, !0),
        l.close(u.tipsIndex),
        n && layui.event.call(e, s, "sort(" + h + ")", { field: r, type: i });
    }),
    ...
    (A.prototype.scrollPatch = function() {
      ...
      if (a && l) {
        ...
        e.layHeader
          ...
          .remove();
      e.layFixed.find(p).css("height", e.layMain.height() - l),
        e.layFixRight[
          i.width() > e.layMain.width() ? "removeClass" : "addClass"
        ](f),
    ...
    (A.prototype.events = function() {
      ...
      u
        ...
        S.on("mousemove", function(t) {
          ...
          c.resizeStart && ((c = {}), o.css("cursor", ""), a.scrollPatch()),
            2 === e && (e = null);
        }),
        u
          .on("click", function() {
            var i,
              ...
              o = n.attr("lay-sort");
            return n[0] && 1 !== e
              ? ((i = "asc" === o ? "desc" : "desc" === o ? null : "asc"),
                void a.sort(l, i, null, !0))
              : (e = 2);
          })
          .find(k + " .layui-edge ")
          .on("click", function(e) {
        ...
        a.layBody
          ...
          .on("blur", "." + w, function() {
            ...
            a.eachCols(function(t, i) {
              ...
              l
                .siblings(f)
                .html(e ? i(t(e).html() || this.value).render(r) : this.value),
        ...
        a.layBody.on("click", "td", function() {
          ...
          if (!e.data("off")) {
            if (e.data("edit")) {
              ...
              return (
                (o[0].value = e.data("content") || i.text()),
                e.find("." + w)[0] || e.append(o),
                o.focus()
              );
            }
                ...
                layui.each(e, function(e, l) {
                  if (e in r) {
                    ...
                    (r[e] = l),
                      ...
                      n
                        .children('td[data-field="' + e + '"]')
                        .children(f)
                        .html(o ? i(t(o).html() || l).render(r) : l);
                  }
                });
            }
          }),
  ...
  var o = layui.$,
    t = {
      fixbar: function(e) {
        ...
        o("." + i)[0] ||
          ...
          u.find("li").on("click", function() {
            var t = o(this),
              a = t.attr("lay-type");
            "top" === a && o("html,body").animate({ scrollTop: 0 }, 200),
      ...
      countdown: function(e, o, t) {
        ...
        return (
          t && t(c > 0 ? n : [0, 0, 0, 0], o, u), c <= 0 && clearTimeout(u), u
        );
      },
      timeAgo: function(e, o) {
        var t = new Date().getTime() - new Date(e).getTime();
        return t > 2592e6
          ? ((t = new Date(e).toLocaleString()),
            o && (t = t.replace(/\s[\S]+$/g, "")),
            t)
          : t >= 864e5
          ? ((t / 1e3 / 60 / 60 / 24) | 0) + "天前"
...
layui.define(["layer", "form"], function(t) {
  ...
  var s = function(t, i, a) {
    ...
    C = {
      html:
        '<i class="layui-icon layedit-tool-html" title="HTML源代码" lay-command="html" layedit-event="html"">&#xe64b;</i><span class="layedit-tool-mid"></span>',
      strong:
      ...
      code:
        '<i class="layui-icon layedit-tool-code" title="插入代码" layedit-event="code">&#xe64e;</i>',
      help:
        '<i class="layui-icon layedit-tool-help" title="帮助" layedit-event="help">&#xe607;</i>'
    },
    w = new c();
  t(n, w);
});
        ...
        layui.each(t.reverse(), function(t, i) {
            ...
            c.find(">.layui-code-h3")[0] ||
              c.prepend(
                '<h3 class="layui-code-h3">' +
                  ...
                  (e.about
                    ? '<a href="' + l + '" target="_blank">layui.code</a>'
                    : "") +
                  "</h3>"
              );
          ...
          c.addClass("layui-box layui-code-view"),
            (c.attr("lay-skin") || e.skin) &&
              c.addClass("layui-code-" + (c.attr("lay-skin") || e.skin)),
            ((d.find("li").length / 100) | 0) > 0 &&
              d.css("margin-left", ((d.find("li").length / 100) | 0) + "px"),
            (c.attr("lay-height") || e.height) &&
              d.css("max-height", c.attr("lay-height") || e.height);
        });
    });
  })
